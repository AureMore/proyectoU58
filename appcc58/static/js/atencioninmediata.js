...
function agregarConsumoCirugia(inventario_id,cantidad_aplicar) {
    ...
    fetch('/agregar_a_consumo_cirugia/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'X-CSRFToken': csrftoken
...
function refreshTablaConsumoCirugia(idAtencion) {
    $.ajax({
        type: 'GET',
        url: '/refresh_table_consumo_cirugia/' + '?idAtencion=' + idAtencion,
        dataType: 'json',
...
function refreshTablaPresupuesto(atencion_inmediata_id) {
    $.ajax({
        type: 'GET',
        url: '/refresh_table_baremo_atencioninmediata/' + '?atencion_inmediata_id=' + atencion_inmediata_id,
...
function guardarTratamiento() {
    ...
    fetch('/agregar_tratamiento_atencioninmediata/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'X-CSRFToken': csrftoken
...
function refreshTratamientoAtencioninmediata(idAtencion) {
    $.ajax({
        type: 'GET',
        url: '/refresh_table_tratamiento_atencioninmediata/' + '?idAtencion=' + idAtencion,
        dataType: 'html',
        success: function(data) {
...
function agregarBaremoAtencion(idBaremo) {
    ...
    fetch('/agregar_presupuesto_atencioninmediata/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'X-CSRFToken': csrftoken
...
function eliminar_cerrar() {
        ...
        fetch('/eliminar_no_concretados_atencion_inmediata/', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
              'X-CSRFToken': csrftoken
          ...
          .then(response => response.json())
          .then(data => {
            window.location.href = '/listado_atencion_inmediata/';
          })
          .catch(error => console.error(error));
