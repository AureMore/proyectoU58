function depositoseleccionado(idDeposito) {
...
function agregarConsumoCirugia(inventario_id,cantidad_aplicar) {
    ...
    fetch('/agregar_a_consumo_cirugia_cortesia/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'X-CSRFToken': csrftoken
...
function refreshTablaConsumoCirugia(idAtencion) {
    $.ajax({
        type: 'GET',
        url: '/refresh_table_consumo_cirugia_cortesia/' + '?idAtencion=' + idAtencion,
        dataType: 'json',
...
function refreshTablaPresupuesto(atencion_inmediata_id) {
    $.ajax({
        type: 'GET',
        url: '/refresh_table_baremo_atencion_cortesia/' + '?atencion_inmediata_id=' + atencion_inmediata_id,
        ...
        success: function(response) {
            ...
            totalSubtotal = String(totalSubtotal).replace(',', '.');
            totalSubtotal = parseFloat(totalSubtotal).toFixed(2)
...
function guardarTratamiento() {
    ...
    fetch('/agregar_tratamiento_atencion_cortesia/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'X-CSRFToken': csrftoken
...
function refreshTratamientoAtencioninmediata(idAtencion) {
    $.ajax({
        type: 'GET',
        url: '/refresh_table_tratamiento_atencion_cortesia/' + '?idAtencion=' + idAtencion,
        dataType: 'html',
        success: function(data) {
...
function agregarBaremoAtencion(idBaremo) {
    ...
    fetch('/agregar_presupuesto_atencion_cortesia/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'X-CSRFToken': csrftoken
...
function eliminar_cerrar() {
        ...
        fetch('/eliminar_no_concretados_atencion_cortesia/', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
              'X-CSRFToken': csrftoken
          ...
          .then(response => response.json())
          .then(data => {
            window.location.href = '/listado_atencion_cortesia/';
          })
          .catch(error => console.error(error));
