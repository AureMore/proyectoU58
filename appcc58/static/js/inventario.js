  $(document).ready(function() {
    $('#tblinventario').on('dblclick', 'tbody tr', function() {
      ...
      var medico_entregado = document.getElementById('medico').value;
      var nota = document.getElementById('id_nota_entrega').value;
      var fila = $(this);
      ...
      const datos = {
        ...
        venta: venta,
        farmacia:farmacia,
        medico_entregado:medico_entregado,
        nota:nota,
        deposito:deposito,
      };
...
function refreshTableFarmacia() {
    const idCirugia = document.getElementById('id_idCirugia').value;
    console.log('refresca id:'+idCirugia)
    $.ajax({
        type: 'GET',
        url: '/refresh_table_farmacia/' + '?idCirugia=' + idCirugia,
        dataType: 'html',
        success: function(data) {
            $('#tabla-farmacia').html(data);
        }
    });
}
...
$(document).ready(function() {
    $('#tabla-depositos').DataTable({
        ...
        language: {
         ...
         // Configura para mostrar 25 registros por página
    });
});
